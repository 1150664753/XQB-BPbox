...
XQB-BPBox 是一款面向《崩坏：星穹铁道》相关 BP 场景的桌面工具，使用 Electron、React 和 TypeScript 开发。项目通过本地文件管理角色、光锥、BP 流程、展示设置、音视频配置和 BP 结果，可用于非商业赛事、社区活动、学习研究及个人内容制作。

> **授权提示：** 本项目源代码公开供个人学习、研究及非商业用途使用。商业使用及商业赛事使用前，必须联系作者并取得授权。项目中包含或由使用者自行配置的第三方游戏图片、角色素材、视频、音频、字体等，不属于本项目程序代码的授权范围。
